...
export class CheckoutPaymentComponent implements OnInit {
    ...
    ngOnInit(): void {
        loadStripe("pk_test_51PTBYXDpeKeTdUYHyZonsFHC6OMHE2MUMedcgcSyj3MWdqYUTrn99XtsBR5q1HRC2mjc97uOuQzV9R60Ich2131w000QehHYvL")
            .then(stripe => {
                this.stripe = stripe;
    ...
    private getOrderToCreate(basket: Basket): OrderToCreate {
        ...
        return {
            basketId: basket.id, deliveryMethodId: deliveryMethodId, shipToAddress: shipToAddress
        }
    ...
    private async confirmPaymentWithStripe(basket: Basket | null) {
        ...
        const result = this.stripe?.confirmCardPayment(basket.clientSecret!, {
            payment_method: {
                card: this.cardNumber!, billing_details: {
